...
public class BoardController {
                ...
                <body>
                  <div class="container">
                    ...
                    <table>
                      ...
                      <tbody>
                """;
        for (PostDto post : posts) {  // 나중에는 데이터를 DB에서 받아오면 된다.
            result += """
                    <tr>
                      <td>%d</td>
                      <td>
                        <a href="detail.html?id=%d">%s</a>
                      </td>
                      <td>%s</td>
                      <td>%s</td>
                      <td>
    ...
    @ResponseBody
    public String getDetail(@RequestParam int id) {
        String result = """
                <!DOCTYPE html>
                <html lang="ko">
                <head>
        ...
        result += """
                    ...
                    <div>
                      <a href="edit.html?id=%d" class="btn">수정하기</a>
